<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="DTcms.Web.about" %>
...
<body>
    <form id="form1" runat="server">
        <div class="page_style sublanmupage page_l62_sl818">
            <uc1:top runat="server" ID="top" />

            <script type="text/javascript">var IsPageHome = ""; var Lanmu_Id = "62"; var Sublanmu_Id = "818"; ShowSubMenu(Lanmu_Id);</script>
            <div class="banner">
                            ...
                            <div id="nav_menu_104" class="nav_menu">
                                <ul id="rootul_104">
                                    <asp:Repeater ID="repMenu" runat="server">
                                        <ItemTemplate>
                                            <li id="<%# Eval("id") %>"><a href="/about.aspx?channel_id=9&category_id=<%# Eval("id") %>" class="sla817"><%# Eval("title") %> </a></li>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </ul>
                            </div>
                        </div>
                        <script type="text/javascript">Initialization_Nav("rootul_104", "sl818", "0");</script>
                    </div>
                    <div class="main_box_inner_right">
                        <div class="current_location current_location_818">
                            <ul>
                            </ul>
                        </div>
                        <div class="sublanmu_box sublanmu_box_818">
