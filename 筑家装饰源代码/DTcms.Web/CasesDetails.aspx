<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CasesDetails.aspx.cs" Inherits="DTcms.Web.CasesDetails" %>
                            ...
                            <div id="nav_menu_105" class="nav_menu">
                                <ul id="rootul_105">
                                    <asp:Repeater ID="repMenu" runat="server">
                                        <ItemTemplate>
                                            <li id="<%# Eval("id") %>"><a href="/cases.aspx?channel_id=9&category_id=<%# Eval("id") %>" class="sla833"><%# Eval("title") %> </a></li>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </ul>
                            </div>
