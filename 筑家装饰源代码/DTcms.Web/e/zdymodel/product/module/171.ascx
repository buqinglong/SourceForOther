...
<%}%><%conn.Open();%><ul class="tpzsdjj_box">
<% 
...
if(i%2==0){
%>
  <li class="col-sm-3 col-xs-6 tpzsdjj_left tpzsdjj_hh animates4">
    <span class="pic"><a href="<%=Detail_Url(dr)%>"><img src="<%=dr["titlepic"].ToString()%>"/></a></span>
    <div class="con">
<a class="title" href="<%=Detail_Url(dr)%>"><%=dr["title"].ToString()%></a>
<span class="cpjj">￥<strong><%=dr["price"].ToString()%>.00</strong></span>
    </div>
  </li>
<%}else{%>
  <li class="col-sm-3 col-xs-6 tpzsdjj_left animates4">
    <span class="pic"><a href="<%=Detail_Url(dr)%>"><img src="<%=dr["titlepic"].ToString()%>"/></a></span>
    <div class="con">
<a class="title" href="<%=Detail_Url(dr)%>"><%=dr["title"].ToString()%></a>
<span class="cpjj">￥<strong><%=dr["price"].ToString()%>.00</strong></span>
