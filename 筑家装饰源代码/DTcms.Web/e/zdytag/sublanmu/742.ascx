...
<table border=0 cellpadding=0 cellspacing=0  align=center width=95% class="feedback_table"><tr><td align=right>分类&nbsp;&nbsp;</td><td><select name="sort" id="sort"><option value="0">选择分类</option><option value="555">咨询</option>
<option value="556">建议</option>
<option value="557">投诉</option>
<option value="558">其他</option>
</select></td></tr>
<tr><td align=right>留言标题 <span style="color:#ff0000">*</span></td><td><input type=text name="title" id="title"  maxlength="200"></td></tr>
<tr><td align=right>姓名 <span style="color:#ff0000">*</span></td><td><input type=text name="pa_truename" id="pa_truename"  maxlength="200"></td></tr>
<tr><td align=right>电话 <span style="color:#ff0000">*</span></td><td><input type=text name="pa_tel" id="pa_tel"  maxlength="200"></td></tr>
<tr><td align=right>邮箱&nbsp;&nbsp;</td><td><input type=text name="email" id="email"onblur="if(!IsEmail(this.value)){alert('无效的邮件格式');document.letter.fbk_email.value=''}" maxlength="200"></td></tr>
