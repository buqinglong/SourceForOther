<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="project.aspx.cs" Inherits="DTcms.Web.project" %>
                                    ...
                                    <asp:Repeater ID="repProject" runat="server">
                                        <ItemTemplate>
                                            <li class="animates4 col-sm-3 col-xs-6">
                                                <a class="pic" href="/ProjectDetails.aspx?id=<%# Eval("id") %>">
                                                    <img src="<%# Eval("img_url") %>" /></a>
                                                <a class="tpzs_title" href="/ProjectDetails.aspx?id=<%# Eval("id") %>"><%# Eval("title") %></a>
                                            </li>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </ul>
