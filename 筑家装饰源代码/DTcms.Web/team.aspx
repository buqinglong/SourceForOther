                ...
                <div class="main_box_inner">
                    <div class="main_box_inner_left">
                        <div id="nav_133" class="nav_box nav_box_menu">
                            <div class="nav_title"><span class="nav_sign">团队介绍</span><span class="nav_more"></span></div>
                            <div id="nav_menu_133" class="nav_menu">
                                <ul id="rootul_133">
                                    <asp:Repeater ID="repMenu" runat="server">
                                        <ItemTemplate>
                                            <li id="<%# Eval("id") %>"><a href="/team.aspx?channel_id=9&category_id=<%# Eval("id") %>" class="sla833"><%# Eval("title") %> </a></li>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </ul>
                            </div>
                                    ...
                                    <asp:Repeater ID="repProject" runat="server">
                                        <ItemTemplate>
                                            <li class="animates4 col-sm-3 col-xs-6">
                                                <a class="pic" href="/TeamDetails.aspx?id=<%# Eval("id") %>" style="width:315px;height:235px">
                                                    <img src="<%# Eval("img_url") %>"  class="gray" onmouseover="show(this)" onmouseout ="showMove(this)"/></a>
                                                <a class="tpzs_title" href="/TeamDetails.aspx?id=<%# Eval("id") %>"><%# Eval("title") %></a>
                                            </li>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </ul>
